...
void DirectX12BouncingBallRenderer::SetObjectSelectionActive(bool active)
{
...
void DirectX12BouncingBallRenderer::SetGhostObjectSlotState(int slotIndex, const BgeObjectSlotState& slot)
{
    if (slotIndex < 0 || slotIndex >= BGE_OBJECT_SLOT_COUNT) {
        return;
    }
